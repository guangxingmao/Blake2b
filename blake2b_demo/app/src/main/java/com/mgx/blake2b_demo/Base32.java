...
/* helper.Base32
 *
 * $Id: helper.Base32.java 1828 2004-04-15 19:04:01Z stack-sf $
 *
...
/**
 * helper.Base32 - encodes and decodes RFC3548 helper.Base32 (see
...
public class Base32 extends Object{
    ...
    /**
     * Encodes byte array to helper.Base32 String.
     *
     * @param bytes
     *            Bytes to encode.
    ...
    /**
     * Decodes the given helper.Base32 String to a raw byte array.
     *
     * @param base32
    ...
    /**
     * For testing, take a command-line argument in helper.Base32, decode, print in
     * hex, encode, print
     *
     * @param args
    ...
    static public void main(String[] args) throws UnsupportedEncodingException, InstantiationException, IllegalAccessException, ClassNotFoundException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (args.length == 0) {
            System.out.println("Supply a helper.Base32-encoded argument.");
