...
int
blake2b_InitPersonal(blake2b_state *S, size_t outlen, const void *personal, size_t personal_len) {
    blake2b_param P[1];
...
Java_com_mgx_blake2b_Blake2bUtil_blake2b(JNIEnv *env,jclass type,jbyteArray msg_,jint length) {
